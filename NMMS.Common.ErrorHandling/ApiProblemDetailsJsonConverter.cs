...
{
    public class ApiProblemDetailsJsonConverter : JsonConverter<ApiProblemDetails>
    {
        ...
        internal static void ReadValue(ref Utf8JsonReader reader, ApiProblemDetails value, JsonSerializerOptions options)
        {
        ...
        internal static void WriteProblemDetails(Utf8JsonWriter writer, ApiProblemDetails value, JsonSerializerOptions options)
        {
            if (value.Type != null)
            {
